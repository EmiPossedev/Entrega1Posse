...
const Evento1 = {
    ...
    fecha: "2025-09-26", precio: 50000};

const Evento2 = {
    nombre: "Obra de teatro", 
    lugar: "Centro Cultural", 
    fecha: "2025-10-15", precio: 9000};
const Evento3 = {
    nombre: "Concierto de La Renga",
    lugar: "Estadio Obras",
    fecha: "2025-11-20", precio: 20000};
...
mostrarEventos();
let eventoSeleccionado = seleccionarEvento();
let cantidadEntradas = obtenerCantidadEntradas();
let precioTotal = calcularPrecioTotal(eventoSeleccionado, cantidadEntradas);
